...
**
** Created: Tue Apr 12 11:25:23 2011
...
static const char qt_meta_stringdata_VideoPlayer[] = {
    "VideoPlayer\0\0width,height\0"
    "setImageSize(int,int)\0"
    "setVideoPlayerResolution(int,int)\0"
    "update()\0_image\0setImageFromCamera(QImage)\0"
};
...
int VideoPlayer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: setImageSize((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        case 1: setVideoPlayerResolution((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: update(); break;
        case 3: setImageFromCamera((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
...
// SIGNAL 0
void VideoPlayer::setImageSize(const int & _t1, const int & _t2)
{
