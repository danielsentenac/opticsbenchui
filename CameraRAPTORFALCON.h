...
/**
 * @file CameraRAPTORFALCON.h
 * @brief Camera backend for RAPTORFALCON.
 */
#ifdef RAPTORFALCONCAMERA
#ifndef CAMERARAPTORFALCON_H
#define CAMERARAPTORFALCON_H
#include <xcliball.h>
#include "Camera.h"

/// \ingroup cameras
/// Raptor Falcon camera implementation.
class CameraRAPTORFALCON : public Camera
{
  Q_OBJECT
